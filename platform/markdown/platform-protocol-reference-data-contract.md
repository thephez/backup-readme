...
| ownerId | array of bytes | Yes | [Identity](platform-protocol-reference-identity) that registered the data contract defining the document ([32 bytes; content media type: `application/x.dash.dpp.identifier`](https://github.com/dashevo/platform/blob/v0.23.0/packages/js-dpp/schema/dataContract/dataContractMeta.json#L352-L358) |
