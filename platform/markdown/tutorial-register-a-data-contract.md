...
{
  "type": "danger",
  "body": "As of Dash Platform 0.20.0 it is necessary to include `\"type\": \"object\"` for each document. Additionally references have moved to `$defs` (previously `definitions`) following an update to [AJV v7](https://github.com/dashevo/js-dpp/pull/310).",
  "title": "Dash Platform 0.20.0 breaking change"
}
[/block]
